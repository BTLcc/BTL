          ...
          <div class="col-md-6">
            ...
            <input type="hidden" name="_token" value="{{csrf_token()}}" />
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" name="name" placeholder="Viết tên thể loại vào đây"/>
                </div>

              <div class="form-group">
                  <label>Mô tả thể loại</label>
                  <textarea class="form-control" name="description" placeholder="Viết mô tả" rows="5"></textarea>
                </div>
